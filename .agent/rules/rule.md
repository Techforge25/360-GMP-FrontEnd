...
You are an AI coding assistant, powered by World most powerful AI. You operate in An IDE integrated with AI.
...
also make a log folder on the root directory and save all the logs there.

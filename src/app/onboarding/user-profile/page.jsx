...
//     if (!formData.logo) return "Please upload a profile photo";
//     if (!formData.currentTitle) return "Current Title is required";

//     if (formData.currentTitle === "Other" && !formData.customTitle)
//       return "Please enter your custom title";

//     if (!formData.phone) return "Phone number is required";
//     if (!isValidPhone(formData.phone)) return "Invalid phone number";
...
//     if (!formData.bio?.trim()) return "Description is required";

//     if (bioLength > 1000) return "Description too long";

//     return null;
//   };

//   const validateStep2 = () => {
//     if (!formData.skills?.length) return "Add at least one skill";
...
//       return "Add at least one job title";

//     if (!formData.employeeType?.length)
//       return "Select employment type";

//     if (!formData.minSalary) return "Minimum salary required";
//     if (!formData.maxSalary) return "Maximum salary required";
...
//         targetJob: formData.jobTitle.join(", "),
//         location: `${formData.city}, ${formData.country === "Other"
...
//     if (currentStep === 2) errorMsg = validateStep2();
//     if (currentStep === 3) errorMsg = validateStep3();
...
//     if (success) setIsSuccessModalOpen(true);
//   };
...
//       <Card className="max-w-5xl mx-auto mt-10 shadow-xl">
...
const Step3 = ({ formData, handleChange }) => (
  <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
    ...
    <div>
      <label className="text-base font-medium mb-2 block">
        Preferred Annual Salary Range (USD) <span className="text-red-500">*</span>
      </label>
      <div className="grid grid-cols-2 gap-4">
        <Input
          placeholder="Min ($)"

...
useEffect(() => {
  ...
  const getStatusColor = (status = "") => {
    ...
    if (s.includes("await") || s.includes("process") || s === "pending") return "bg-amber-100 text-amber-800";
    if (s.includes("transit") || s.includes("ship")) return "bg-purple-100 text-purple-800";
    if (s.includes("deliv") || s === "completed") return "bg-green-100 text-green-800";
            ...
            <div className="overflow-x-auto border border-gray-200 rounded-lg">
              <table className="w-full min-w-[900px]">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-5 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Order ID</th>
                    <th className="px-5 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Buyer</th>
                    <th className="px-5 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider hidden sm:table-cell">Order Date</th>
                    <th className="px-5 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Total</th>
                    <th className="px-5 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider hidden md:table-cell">Order Type</th>
                    <th className="px-5 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Status</th>
                    <th className="px-5 py-4 text-right text-xs font-medium text-gray-600 uppercase tracking-wider">Action</th>
                  </tr>
                </thead>

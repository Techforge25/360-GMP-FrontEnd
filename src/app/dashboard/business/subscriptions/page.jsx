      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <span className="inline-block px-4 py-1.5 rounded-full bg-[#E6F6E9] border border-[#0B8806] text-[#0B8806] text-xs font-semibold mb-6">
              Active Plan
            </span>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="flex items-center gap-2 px-6 py-3 bg-[#240457] text-white rounded-lg text-sm font-medium hover:bg-gray-900 transition-colors">
                <span>Manage Plan</span>
                <FiArrowRight />
              </button>
              <button className="px-6 py-3 bg-white border border-red-500 text-red-500 rounded-lg text-sm font-medium hover:bg-red-50 transition-colors">
                Cancel Recent Plan
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <button className="w-full flex items-center gap-2 p-4 text-sm text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                <img src="/assets/images/workspace_premium.png" alt="check" className="w-4 h-5" />
                <span className="text-gray-500 text-sm font-semibold">
                  Current Plan
                </span>
              </div>
              <p className="text-2xl font-medium text-gray-900">Silver</p>
              <p className="text-xs text-gray-500 mt-1">Renew Automatically</p>
            </div>

            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                <img src="/assets/images/calendar_month.png" alt="check" className="w-4 h-5" />
                <span className="text-gray-500 text-sm font-semibold">
                  Next Billing Date
                </span>
              </div>
              <p className="text-2xl font-medium text-gray-900">Nov 24, 2023</p>
              <p className="text-xs text-gray-500 mt-1">Amount: $199.00</p>
            </div>

            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                <img src="/assets/images/attach_money.png" alt="check" className="w-3 h-5" />
                <span className="text-gray-500 text-sm font-semibold">
                  Total Spent YTD
                </span>
              </div>
            ...
            <div className="p-6 border-b-2 border-gray-200 flex flex-col md:flex-row gap-4 justify-between items-center">
              <div className="relative w-full md:max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-200 text-gray-700 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
              <div className="flex items-center gap-3 w-full md:w-auto">
                <button className="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-lg text-sm text-gray-800 hover:bg-gray-50">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="px-6 py-4 text-left text-xs font-medium flex gap-2 items-center text-black uppercase tracking-wider">
                      <input
                        type="checkbox"
                  ...
                  {[
                    ...
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-right">
                        <button className="flex items-center justify-end gap-1 text-xs text-gray-500 hover:text-gray-900 w-full">
                          <span>PDF</span>
            ...
            <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <div className="flex items-center gap-1">
                  <button className="px-3 flex items-center gap-1 py-1 text-gray-400 border border-gray-200 rounded bg-[#EAEBED] text-sm disabled:opacity-50">
                ...
                {[1, 2, 3, 4, 5].map((page) => (
                  <button
                    key={page}
                    className="w-8 h-8 flex text-black items-center justify-center border border-gray-200 rounded hover:bg-gray-50 text-sm"
                  >
                    {page}
                  </button>
                ))}
                <span className="text-gray-500">...</span>
                <button className="w-8 h-8 text-black flex items-center justify-center border border-gray-200 rounded hover:bg-gray-50 text-sm">
                  20
                </button> 
                <button className="px-3 py-1 bg-[#240457] text-white rounded font-[100] hover:bg-gray-900 text-sm flex items-center gap-1">
                  Next <FiChevronRight />
                </button>
              </div>
            </div>

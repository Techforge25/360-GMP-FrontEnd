...
import { FiCreditCard, FiClock, FiDollarSign, FiTrendingUp, FiShield, FiZap } from "react-icons/fi";
          ...
          <div className="px-8 py-12 text-center">
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                We're building a comprehensive business wallet system that will revolutionize how you handle payments, manage cash flow, and track your financial performance. Get ready for seamless transactions and detailed financial insights.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Accept multiple payment methods</p>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Track revenue and expenses</p>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-8">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Your Business Wallet Will Include:</h3>
              ...
              <div className="bg-gradient-to-r from-[#240457] to-[#9747FF] text-white p-6 rounded-xl">
                ...
                <p className="text-white/90 mb-4">
                  Be ready to transform how you manage payments and track your business financial health.
                </p>

        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#110026] to-[#240457] px-8 py-12 text-center text-white">
            ...
            <p className="text-gray-200 text-lg max-w-2xl mx-auto">
              Access 24/7 technical assistance, browse our knowledge base, and
              manage your support tickets for a seamless platform experience.
            </p>
          </div>
          ...
          <div className="px-8 py-12 text-center text-gray-900">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                We're building an integrated support ecosystem. Soon you'll be
                able to initiate live chats with our technical team, submit
                detailed support tickets, and access an extensive library of
                tutorials designed to help your business thrive on 360GMP.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Real-time answers from our dedicated agents
                  </p>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Track and manage complex technical issues
                  </p>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Self-service guides and platform tutorials
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#110026] to-[#240457] text-white p-6 rounded-xl">
                ...
                <p className="text-gray-200 mb-4">
                  We'll notify you as soon as the live multi-channel support
                  system is launched.
                </p>

      ...
      <div className="mx-auto mb-4 sm:mb-6 lg:mb-8 bg-[#110026] relative overflow-hidden">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end p-4 sm:p-6 lg:p-8 xl:p-12 relative z-10 max-w-[1400px] mx-auto">
          <div className="w-full lg:w-1/2 space-y-3 sm:space-y-4 text-center lg:text-left">
            <h1 className="text-2xl sm:text-3xl lg:text-3xl xl:text-4xl font-bold text-white">My Orders</h1>
            <p className="text-sm sm:text-base lg:text-base text-gray-200">
              360GMP Escrow Protection: Secure payments with guaranteed delivery
              confirmation.
            </p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[700px]">
              <thead className="bg-[#F0F0F0]">
                <tr>
                  <th className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">
                    Order ID
                  </th>
                  <th className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">
                    Seller
                  ...
                  <th className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-right text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">
                    Action
                  </th>
                </tr>
              </thead>

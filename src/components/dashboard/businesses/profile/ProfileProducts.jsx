  ...
  return (
    <div className="mb-10">
      ...
      <div className="mt-8 flex justify-center">
        <Link
          href={productsUrl}
          className="bg-white border border-gray-200 text-gray-700 px-6 py-2.5 rounded-xl text-sm font-semibold flex items-center gap-2 hover:bg-gray-50 transition-colors shadow-sm"
        >

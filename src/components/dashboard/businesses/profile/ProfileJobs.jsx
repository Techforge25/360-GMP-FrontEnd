        ...
        {jobsList.map((job) => (
          <div key={job.id || job._id} className="border border-gray-100 rounded-lg p-5 flex flex-col md:flex-row gap-4 hover:border-indigo-100 hover:shadow-sm transition-all">
            ...
            <div className="flex items-center">
              <button className="border border-indigo-200 text-indigo-900 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-indigo-50 transition-colors" onClick={() => router.push(`/dashboard/business/jobs/${job._id}`)}>
                View Details &gt;
              </button>
            </div>
          </div>

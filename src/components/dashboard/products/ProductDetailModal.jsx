      ...
      <div className="bg-white rounded-2xl w-full max-w-5xl max-h-[90vh] flex flex-col shadow-xl overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="border border-indigo-900/10 rounded-xl overflow-hidden">
                ...
                <div className="p-4 space-y-4">
                  <div>
                    ...
                    <div className="w-full text-sm p-3 bg-white border border-gray-200 rounded-lg text-gray-600">
                  ...
                  <div>
                    ...
                    <div className="w-full text-sm p-3 bg-white border border-gray-200 rounded-lg text-gray-600 flex justify-between items-center">
              ...
              <div className="bg-blue-50/30 rounded-xl p-4 flex flex-wrap items-center justify-between gap-4 border border-blue-100">
                ...
                <div className="flex gap-8">
                  <div>
                    ...
                    <div className="bg-white border border-gray-200 px-3 py-1.5 rounded-lg text-sm text-gray-600 min-w-[80px]">
            ...
            <div className="w-full lg:w-80 space-y-6 flex-shrink-0">
              ...
              <div>
                ...
                <div className="w-full text-sm p-3 bg-white border border-gray-200 rounded-lg text-gray-500">
                  {product.title}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full text-sm p-3 bg-white border border-gray-200 rounded-lg text-gray-500 min-h-[120px]">
                  {product.detail ||
                    product.description ||
        ...
        <div className="p-6 border-t border-gray-100 flex justify-end">
          <button
            ...
            className="px-8 py-2.5 bg-[#240457] text-white text-xs font-bold rounded-lg hover:bg-[#1a0340] transition-colors"
          >
            Edit Post
          </button>
        </div>

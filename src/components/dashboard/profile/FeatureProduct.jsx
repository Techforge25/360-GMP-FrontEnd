        ...
        {products.map((product) => (
          ...
          >
            <div className="aspect-[4/3] bg-gray-50 relative p-3 sm:p-4 flex items-center justify-center">
              {/* Stock Badge */}
              <div
                className={`absolute top-2 sm:top-3 right-2 sm:right-3 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-xl sm:rounded-2xl text-[9px] sm:text-[10px] font-bold text-white ${product.stockColor || "bg-green-600"}`}
              >
                Stock {product.stock}
              </div>
            ...
            <div className="p-3 sm:p-4">
              ...
              <button className="w-full py-1.5 sm:py-2 border border-[#240457] rounded-lg text-xs sm:text-sm font-semibold text-[#240457] hover:bg-gray-50 transition-all">
                View Product
              </button>
            </div>
          </div>

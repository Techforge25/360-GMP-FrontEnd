        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#240457] to-[#9747FF] px-8 py-12 text-center">
            ...
            <p className="text-white/90 text-lg max-w-[1400px] mx-auto">
              Complete your purchase with our secure payment system and enjoy
          ...
          <div className="px-8 py-12 text-center">
            <div className="max-w-[1400px] mx-auto">
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                We're building a comprehensive checkout experience with secure
                payment processing, multiple payment options, and real-time
                order tracking. Get ready for a seamless purchasing journey.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Escrow protection & encrypted transactions
                  </p>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Credit card, bank transfer & more
                  </p>
                </div>
              ...
              <div className="bg-gradient-to-r from-[#240457] to-[#9747FF] text-white p-6 rounded-xl">
                ...
                <p className="text-white/90 mb-4">
                  We'll send you an update as soon as checkout becomes
                  available.
                </p>

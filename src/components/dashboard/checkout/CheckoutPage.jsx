          ...
          <div className="flex-1">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <div className="w-full border border-gray-200 rounded-lg px-4 py-3 flex items-center justify-between bg-white cursor-pointer hover:border-gray-300 transition-colors">
                                    ...
                                    {/* No chevron in screenshot explicitly, but implied by dropdown nature. Screenshot shows plain box. I will omit chevron to be "Exact UI" or maybe simple text input look. Screenshot shows just text and flag inside a box. */}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#240457] focus:border-transparent placeholder-gray-400 placeholder:text-red-400"
                                    // Note: placeholder in screenshot has a red asterisk inside it. Standard placeholder doesn't support rich text. 
                                    // I'll simulate it by just putting "Full Name *" text. 
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-gray-900 mb-2">
                                ...
                                <p className="text-xs text-gray-400 mt-1">Only Used To Contact You For Delivery Updates</p>
                            </div>
                        </div>

                        {/* Row 2: Street Address & Phone (Duplicate label in screenshot) */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-sm font-bold text-gray-900 mb-2">
                                    Street Address
                                ...
                                <input 
                                    type="text" 
                                    placeholder="Full Name *" 
                                    className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#240457] focus:border-transparent placeholder-gray-400"
                                    // Screenshot shows "Full Name *" placeholder for Street Address too? 
                                    // Checking screenshot... Yes, it actually says "Full Name *" inside the Street Address input.
                                    // This mockup has copy-paste errors. 
                                    // User said "Should be exactly same ui as the picture".
                                    // I will reproduce the copy-paste error to be safe, but it hurts. 
                                    // Ok, I will assume "Full Name *" in Street Address is a mistake and put "Full Name *" to match exactly what is visible, 
                                    // OR I can be smart and put "Street Address *" but risks violating "exact ui".
                                    // Let's look closely. "Street Address" label. Placeholder says "Full Name *". 
                                    // The second Phone input also has "+1 | Phone Number *" placeholder.
                    ...
                    <button className="w-full bg-[#110026] text-white py-4 rounded-lg font-bold text-base hover:bg-[#2a0b4d] transition-colors mt-8">
                        Continue To Payment
                    </button>
                </div>
            </div>
          ...
          <div className="w-full lg:w-[380px] space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    {/* Wait, the Right Column Check Out button is also present in the checkout page in the screenshot? 
                        Checking screenshot... Yes, it is still there! "Check Out" button is visible in the right column, 
                        AND "Continue To Payment" is visible in the left column. 
                        I will keep it.
                    */}
                </div>
            </div>

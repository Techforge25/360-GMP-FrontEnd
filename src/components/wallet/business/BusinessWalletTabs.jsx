                    ...
                    {businessWalletTabs.map((tab) => (
                         <button
                              ...
                              className={`px-4 py-2 text-sm transition-colors ${activeTabs === tab
                                   ? "border-b-2 border-text-brand-primary text-brand-primary font-inter font-normal text-[16px] leading-[32px] tracking-normal text-center align-middle capitalize"
                                   : "border-b-2 border-transparent text-gray-500 hover:text-gray-800 font-inter font-normal text-base leading-[32px] tracking-normal text-center align-middle capitalize"
                                   }`}
                         >
                              {tab}
                         </button>
